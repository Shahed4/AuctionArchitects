...
export default function CarDetail() {
  return (
    <Container
      maxWidth="lg"
      sx={{ py: 5, px: 3, backgroundColor: "#000", color: "#fff" }}
    >
      <Typography
        variant="h3"
        gutterBottom
      ...
      <Box sx={{ display: "flex", gap: 6, alignItems: "flex-start" }}>
        ...
        <Box sx={{ flex: 1 }}>
          ...
          <Typography variant="body1" paragraph sx={{ color: "#f5f5f5" }}>
            <strong>Overview:</strong> The 2023 Toyota Camry SE is a stylish and
            fuel-efficient sedan, known for its reliability and smooth handling.
            Equipped with modern technology and safety features, it’s ideal for
